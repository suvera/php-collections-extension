...
$obj0 = new StdVector(TYPE_COMPLEX_OBJECT);
$memcgeck[1] = memory_get_usage();
$obj1 = new StdVector(TYPE_COMPLEX_OBJECT);
$memcgeck[2] = memory_get_usage();
$obj2 = new StdVector(TYPE_COMPLEX_OBJECT);
$memcgeck[3] = memory_get_usage();
$obj3 = new StdVector(TYPE_COMPLEX_OBJECT);
$memcgeck[4] = memory_get_usage();
$obj4 = new StdVector(TYPE_COMPLEX_OBJECT);
...
$obj5 = new StdVector(TYPE_COMPLEX_OBJECT);
...
$obj->sort(function ($obj1, $obj2) {
    //echo "in closure ($obj1->num < $obj2->num)\n";
    return $obj1->num < $obj2->num;
});

$arr = array(new ABC(1), new ABC(3), new ABC(5), new ABC(8), new ABC(9), new ABC(10));
